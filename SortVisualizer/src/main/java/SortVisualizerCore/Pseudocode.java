...
public class Pseudocode {
    ...
    public Animation changeLabelProperties(int lineNumber, String newText){
        ...
        KeyFrame newTextFrame = new KeyFrame(Duration.ZERO, event -> labels.get(lineNumber - 1).setText(newText));
        KeyFrame newStyleFrame = new KeyFrame(Duration.ZERO, event -> labels.get(lineNumber - 1).setStyle(newStyle));
